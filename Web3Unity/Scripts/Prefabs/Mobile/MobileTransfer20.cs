...
public class MobileTransfer20 : MonoBehaviour
{
    async public void Transfer()
    {
        ...
        string contract = "0xc7AD46e0b8a400Bb3C915120d284AafbA8fc4735"; // dai contract on rinkeby
        string toAccount = "0x428066dd8A212104Bc9240dCe3cdeA3D3A0f7979"; // sent token to
        string amount = "1000000000000000000"; // token amount
